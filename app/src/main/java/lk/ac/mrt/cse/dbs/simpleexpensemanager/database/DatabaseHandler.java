...
public class databaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String accountTable = "CREATE TABLE "+accountTable+"("+accountNo+" VARCHAR(20) NOT NULL PRIMARY KEY,"+bankName+" VARCHAR(100) NULL,"+accountHolderName+" VARCHAR(100) NULL,"+balance+" DECIMAL(10,2) NULL );";

        String transactionTable = "CREATE TABLE "+getTransactionTable()+"("+transactionId+" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,"+accountNo+" VARCHAR(20) NOT NULL,"+date+" DATE NULL,"+amount+" DECIMAL(10,2) NULL,"+expenseType+" VARCHAR(100) NULL, FOREIGN KEY("+accountNo+") REFERENCES "+accountTable+"("+accountNo+");";
